...
const token = `suxiaoyou_st_${randomBytes(32).toString("base64url")}`;

const env = {
  ...process.env,
  SUXIAOYOU_ALLOW_DEV_SESSION_TOKEN: "true",
  SUXIAOYOU_DEV_SESSION_TOKEN: token,
  NEXT_PUBLIC_SUXIAOYOU_DEV_SESSION_TOKEN: token,
