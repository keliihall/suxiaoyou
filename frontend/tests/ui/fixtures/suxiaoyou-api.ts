...
export interface 苏小有MockOptions {
  failUploads?: string[];
...
const sessionAlpha: SessionRecord = {
  ...
  parent_id: null,
  slug: null,
  directory: "/Users/alex/suxiaoyou-demo",
...
const sessionDefaultDirectory = {
  ...sessionAlpha,
  id: "session-default-directory",
  directory: ".",
  title: "Default folder notes",
  is_pinned: false,
  summary_additions: 0,
  summary_deletions: 0,
  summary_files: 0,
  time_created: "2026-04-24T08:00:00.000Z",
  time_updated: "2026-04-24T09:00:00.000Z",
};
      ...
      parts: [
        ...
        },
        {
          ...
          data: {
            ...
            path: "/tmp/suxiaoyou-ui/sample-preflight.csv",
            size: 128,
            mime_type: "text/csv",
            source: "uploaded",
            content_hash: "hash-1",
        ...
        },
        {
          ...
          data: {
            ...
            path: "/Users/alex/suxiaoyou-demo/docs/release-notes.md",
            size: 256,
...
function createdMessagePageForState(state: 苏小有MockState) {
  const page = cloneJson(createdMessagePage);
      ...
      parts: [
        {
          ...
          data: {
            type: "text",
            text: "I prepared the release pack and plan review artifacts.\n\nOffice files for review: `/Users/alex/suxiaoyou-demo/docs/office-brief.docx`, `/Users/alex/suxiaoyou-demo/data/office-matrix.xlsx`, `/Users/alex/suxiaoyou-demo/docs/office-report.pdf`, `/Users/alex/suxiaoyou-demo/slides/office-deck.pptx`, and `/Users/alex/suxiaoyou-demo/data/missing-report.xlsx`.",
          },
        },
        artifactToolPart(
          "session-artifacts",
        ...
        artifactToolPart(
          ...
          "artifact-html",
          {
            ...
            content:
              "<main><h1>苏小有 GUI Preflight</h1><p>End-to-end browser coverage.</p></main>",
          },
        ),
        artifactToolPart(
          "session-artifacts",
        ...
        artifactToolPart(
          ...
          "artifact-svg",
          {
            ...
            content:
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 80"><rect width="120" height="80" rx="10" fill="#0f172a"/><text x="18" y="46" fill="white" font-size="20">苏小有</text></svg>',
          },
        ),
        {
          ...
          data: {
            ...
            state: {
              ...
              input: {
                ...
                files_to_modify: [
                  "frontend/tests/ui/suxiaoyou-preflight.spec.ts",
                ],
              },
              output: null,
              metadata: {
                ...
                plan: "## Plan\n\n1. Run desktop workflows.\n2. Run settings workflows.\n3. Run mobile handoff workflows.",
                plan_path:
                  "/Users/alex/suxiaoyou-demo/.suxiaoyou/plans/gui-preflight.md",
                files_to_modify: [
                  "frontend/tests/ui/suxiaoyou-preflight.spec.ts",
                ],
              },
...
function seededSettings(options: 苏小有SeedOptions = {}) {
  return {
    state: {
...
export async function seed苏小有Storage(
  page: Page,
  options: 苏小有SeedOptions = {},
) {
  const overwrite =
    options.force === true ||
  ...
  await page.addInitScript(
    ({ settings, overwrite: shouldOverwrite }) => {
      ...
      setValue("suxiaoyou_remote_provider", "openrouter");
    },
...
function makePdfBase64() {
  const objects = [
    ...
    "<< /Length 70 >>\nstream\nBT /F1 18 Tf 48 150 Td (苏小有 PDF workflow) Tj 0 -28 Td (Page 1) Tj ET\nendstream",
  ...
  zip.file(
    ...
    xml(
      '<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">' +
        ...
        '<p:sp><p:nvSpPr><p:cNvPr id="2" name="Title 1"/><p:cNvSpPr txBox="1"/><p:nvPr/></p:nvSpPr><p:spPr><a:xfrm><a:off x="914400" y="914400"/><a:ext cx="7315200" cy="914400"/></a:xfrm><a:prstGeom prst="rect"><a:avLst/></a:prstGeom></p:spPr><p:txBody><a:bodyPr/><a:lstStyle/><a:p><a:r><a:rPr lang="en-US" sz="3600"/><a:t>苏小有 PPTX workflow</a:t></a:r></a:p></p:txBody></p:sp>' +
    ...
    officeFixturesPromise = (async () => {
      ...
      return Object.fromEntries(
        fixtures.map((fixture) => [
          ...
          {
            ...fixture,
            path: `/Users/alex/suxiaoyou-demo/${fixture.name}`,
    ...
    return [
      ...
      sseEvent(2, "permission-request", {
        ...
        arguments: {
          ...
          cwd: "/Users/alex/suxiaoyou-demo/frontend",
        },
  ...
  if (streamId === "stream-plan") {
    return [
      ...
      sseEvent(2, "plan-review", {
        ...
        files_to_modify: [
          "frontend/tests/ui/suxiaoyou-preflight.spec.ts",
          "frontend/tests/ui/fixtures/suxiaoyou-api.ts",
        ],
      }),
      "",
    ].join("\n");
...
export async function mock苏小有Api(
  page: Page,
  options: 苏小有MockOptions = {},
): Promise<苏小有MockState> {
  const state: 苏小有MockState = {
    promptBodies: [],
    editBodies: [],
    chatResponses: [],
    abortRequests: [],
  ...
  const sessionRecords = new Map<string, SessionRecord>([
    ...
    [sessionDefaultDirectory.id, cloneJson(sessionDefaultDirectory)],
  ...
  const handler = async (route: Route) => {
    ...
    if (path.endsWith("/files")) {
      return fulfillJson(route, {
        files: [
          {
            name: "plan.md",
            path: "/Users/alex/suxiaoyou-demo/plan.md",
            type: "file",
            tool: "write",
          },
          {
            name: "office-brief.docx",
            path: "/Users/alex/suxiaoyou-demo/docs/office-brief.docx",
            type: "file",
            tool: "write",
          },
          {
            name: "office-matrix.xlsx",
            path: "/Users/alex/suxiaoyou-demo/data/office-matrix.xlsx",
            type: "file",
            tool: "write",
          },
          {
            name: "office-report.pdf",
            path: "/Users/alex/suxiaoyou-demo/docs/office-report.pdf",
            type: "file",
            tool: "write",
          },
          {
    ...
    if (path === "/api/files/upload" && method === "POST") {
      ...
      return fulfillJson(route, {
        ...
        name: filename,
        path: `/tmp/suxiaoyou-ui/${filename}`,
        size: 128,
      ...
      return fulfillJson(route, [
        {
          ...
          absolute_path: "/Users/alex/suxiaoyou-demo/docs/release-notes.md",
        },
        {
          name: "preflight-matrix.csv",
          relative_path: "data/preflight-matrix.csv",
          absolute_path: "/Users/alex/suxiaoyou-demo/data/preflight-matrix.csv",
        },
      ]);
    }
    ...
    if (path === "/api/files/browse-directory") {
      return fulfillJson(route, { path: "/Users/alex/suxiaoyou-demo" });
    }
    if (path === "/api/files/list-directory") {
      return fulfillJson(route, {
        path: "/Users/alex/suxiaoyou-demo",
        parent: "/Users/alex",
        entries: [
          {
            name: "docs",
            path: "/Users/alex/suxiaoyou-demo/docs",
            is_directory: true,
          },
          {
            name: "src",
            path: "/Users/alex/suxiaoyou-demo/src",
            is_directory: true,
          },
        ],
      });
    ...
    if (path === "/api/skills/store/search") {
      return fulfillJson(route, {
        ...
        data: {
          ...
          filters: { search: "", sortBy: "stars" },
        },
        meta: {
          available: false,
          source: "disabled",
          reason: "Online skill discovery is not included in this release.",
        },
      });
    }
    ...
    if (path === "/api/remote/enable") {
      ...
      return fulfillJson(route, {
        token: "remote-token",
        tunnel_url: "https://remote.suxiaoyou.test",
      });
    }
    ...
    if (path === "/api/workspace-memory/list") {
      return fulfillJson(route, [
        {
          workspace_path: "/Users/alex/suxiaoyou-demo",
    ...
    if (path === "/api/workspace-memory/export")
      return fulfillJson(route, { exported_to: "/tmp/suxiaoyou-memory.md" });
  ...
  await page.route("https://api.suxiaoyou.com/**", handler);
