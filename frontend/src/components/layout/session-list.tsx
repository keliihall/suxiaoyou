...
function ProjectRow({
  ...
  const canOpenDirectory = IS_DESKTOP && !isRemoteMode();
  ...
  const MenuItems = useCallback(
    ...
    [canOpenDirectory, collapsed, copyDirectory, onToggle, openDirectory, openDirectoryLabel, startNewChat, t],
  );
