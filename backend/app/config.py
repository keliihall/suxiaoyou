...
class Settings(BaseSettings):
    ...
    openai_api_key: str = ""        # SUXIAOYOU_OPENAI_API_KEY
    anthropic_api_key: str = ""     # SUXIAOYOU_ANTHROPIC_API_KEY
    google_api_key: str = ""        # SUXIAOYOU_GOOGLE_API_KEY
    groq_api_key: str = ""          # SUXIAOYOU_GROQ_API_KEY
    deepseek_api_key: str = ""      # SUXIAOYOU_DEEPSEEK_API_KEY
    mistral_api_key: str = ""       # SUXIAOYOU_MISTRAL_API_KEY
    xai_api_key: str = ""           # SUXIAOYOU_XAI_API_KEY
    together_api_key: str = ""      # SUXIAOYOU_TOGETHER_API_KEY
    deepinfra_api_key: str = ""     # SUXIAOYOU_DEEPINFRA_API_KEY
    cerebras_api_key: str = ""      # SUXIAOYOU_CEREBRAS_API_KEY
    cohere_api_key: str = ""        # SUXIAOYOU_COHERE_API_KEY
    perplexity_api_key: str = ""    # SUXIAOYOU_PERPLEXITY_API_KEY
    fireworks_api_key: str = ""     # SUXIAOYOU_FIREWORKS_API_KEY
    azure_openai_api_key: str = ""  # SUXIAOYOU_AZURE_OPENAI_API_KEY
    azure_openai_base_url: str = "" # SUXIAOYOU_AZURE_OPENAI_BASE_URL
    qwen_api_key: str = ""          # SUXIAOYOU_QWEN_API_KEY (Alibaba DashScope)
    kimi_api_key: str = ""          # SUXIAOYOU_KIMI_API_KEY (Moonshot)
    minimax_api_key: str = ""       # SUXIAOYOU_MINIMAX_API_KEY
    zhipu_api_key: str = ""         # SUXIAOYOU_ZHIPU_API_KEY (智谱 GLM)
    siliconflow_api_key: str = ""   # SUXIAOYOU_SILICONFLOW_API_KEY (硅基流动)
    xiaomi_api_key: str = ""        # SUXIAOYOU_XIAOMI_API_KEY (MiMo)
    custom_endpoints: str = "[]"    # SUXIAOYOU_CUSTOM_ENDPOINTS
    ...
    disabled_providers: str = ""  # SUXIAOYOU_DISABLED_PROVIDERS
    ...
    # --- Database ---
    database_url: str = "sqlite+aiosqlite:///./data/suxiaoyou.db"
    ...
    local_base_url: str = ""  # SUXIAOYOU_LOCAL_BASE_URL
    ...
    # the ``SUXIAOYOU_SESSION_TOKEN_PATH`` env var when the contract differs
